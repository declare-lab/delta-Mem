...
run_eval_task_for_all_variants() {
  ...
  case "${task_name}" in
    locomo)
      variant_enabled "base_model" && run_locomo_base_like "base_model" "30671"
      variant_enabled "SSW_rank8_qasper_write8192" && run_locomo_delta_only "SSW_rank8_qasper_write8192" "${SSW_ADAPTER_DIR}" "30672"
      variant_enabled "TSW_rank8_qasper_write8192" && run_locomo_delta_only "TSW_rank8_qasper_write8192" "${TSW_ADAPTER_DIR}" "30673"
      variant_enabled "MSW_qasper_write8192" && run_locomo_delta_only "MSW_qasper_write8192" "${MSW_ADAPTER_DIR}" "30674"
      ;;
    hotpotqa|gpqa_diamond|ifeval|memory_agent_bench)
      variant_enabled "base_model" && run_benchmark_task_base_like "base_model" "${task_name}" "30771"
      variant_enabled "SSW_rank8_qasper_write8192" && run_benchmark_task_delta_only "SSW_rank8_qasper_write8192" "${SSW_ADAPTER_DIR}" "${task_name}" "30772"
      variant_enabled "TSW_rank8_qasper_write8192" && run_benchmark_task_delta_only "TSW_rank8_qasper_write8192" "${TSW_ADAPTER_DIR}" "${task_name}" "30773"
      variant_enabled "MSW_qasper_write8192" && run_benchmark_task_delta_only "MSW_qasper_write8192" "${MSW_ADAPTER_DIR}" "${task_name}" "30774"
      ;;
    *)
