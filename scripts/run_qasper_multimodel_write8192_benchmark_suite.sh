...
SUITE_ROOT="${SUITE_ROOT:-/vePFS-Mindverse/share/models/leijingdi/results/qasper_multimodel_write8192_benchmark_suite_consistent70}"
...
MEMORY_AGENT_BENCH_ROOT="${MEMORY_AGENT_BENCH_ROOT:-/root/code/external/MemoryAgentBench}"
LOCOMO_DATA_FILE="${LOCOMO_DATA_FILE:-/root/code/Delta-Mem/data/locomo10.json}"
...
SSW_ADAPTER_DIR="${SSW_ADAPTER_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_4b_instruct_delta_mem_qasper_6k_seed42_rank8_qo_SSW_write8192_consistent70/trainer/checkpoint-70}"
TSW_ADAPTER_DIR="${TSW_ADAPTER_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_4b_instruct_delta_mem_qasper_6k_seed42_rank8_qo_TSW_write8192_consistent70/trainer/checkpoint-70}"
MSW_ADAPTER_DIR="${MSW_ADAPTER_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_4b_instruct_delta_mem_qasper_6k_seed42_MSW_write8192_consistent70/trainer/checkpoint-70}"
...
run_eval_task_for_all_variants() {
  ...
  case "${task_name}" in
    locomo)
      variant_enabled "base_model" && run_locomo_base_like "base_model" "29671"
      variant_enabled "SSW_rank8_qasper_write8192" && run_locomo_delta_only "SSW_rank8_qasper_write8192" "${SSW_ADAPTER_DIR}" "29672"
      variant_enabled "TSW_rank8_qasper_write8192" && run_locomo_delta_only "TSW_rank8_qasper_write8192" "${TSW_ADAPTER_DIR}" "29673"
      variant_enabled "MSW_qasper_write8192" && run_locomo_delta_only "MSW_qasper_write8192" "${MSW_ADAPTER_DIR}" "29674"
      ;;
    hotpotqa|gpqa_diamond|ifeval|memory_agent_bench)
      variant_enabled "base_model" && run_benchmark_task_base_like "base_model" "${task_name}" "29771"
      variant_enabled "SSW_rank8_qasper_write8192" && run_benchmark_task_delta_only "SSW_rank8_qasper_write8192" "${SSW_ADAPTER_DIR}" "${task_name}" "29772"
      variant_enabled "TSW_rank8_qasper_write8192" && run_benchmark_task_delta_only "TSW_rank8_qasper_write8192" "${TSW_ADAPTER_DIR}" "${task_name}" "29773"
      variant_enabled "MSW_qasper_write8192" && run_benchmark_task_delta_only "MSW_qasper_write8192" "${MSW_ADAPTER_DIR}" "${task_name}" "29774"
      ;;
    *)
