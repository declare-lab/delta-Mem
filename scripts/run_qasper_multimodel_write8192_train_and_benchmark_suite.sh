...
# Paths
ROOT_DIR="${ROOT_DIR:-/root/code/Delta-Mem}"
PYTHON_BIN="${PYTHON_BIN:-/root/code/Delta-Mem/.venv/bin/python}"
PIPELINE_ROOT="${PIPELINE_ROOT:-/vePFS-Mindverse/share/models/leijingdi/results/qasper_multimodel_write8192_train_and_benchmark_suite_consistent70}"
LOG_ROOT="${LOG_ROOT:-${PIPELINE_ROOT}/logs}"
MANIFEST_PATH="${MANIFEST_PATH:-${PIPELINE_ROOT}/run_manifest.txt}"
EVAL_SCRIPT="${EVAL_SCRIPT:-/root/code/Delta-Mem/scripts/run_qasper_multimodel_write8192_benchmark_suite.sh}"
WANDB_DIR="${WANDB_DIR:-/vePFS-Mindverse/share/models/leijingdi/wandb}"
HF_HOME="${HF_HOME:-/vePFS-Mindverse/share/huggingface}"
HF_HUB_CACHE="${HF_HUB_CACHE:-/vePFS-Mindverse/share/huggingface/hub}"
HF_DATASETS_CACHE="${HF_DATASETS_CACHE:-/vePFS-Mindverse/share/datasets_cache}"
TOKENIZED_DATASET_ROOT="${TOKENIZED_DATASET_ROOT:-/vePFS-Mindverse/share/dataset/deltamem_tokenized}"
DEEPSPEED_CONFIG="${DEEPSPEED_CONFIG:-/root/code/Delta-Mem/deepspeed_zero2.json}"
BASE_MODEL_PATH="${BASE_MODEL_PATH:-/vePFS-Mindverse/share/huggingface/hub/models--Qwen--Qwen3-4B-Instruct-2507/snapshots/cdbee75f17c01a7cc42f958dc650907174af0554}"
TRAIN_FILE="${TRAIN_FILE:-/vePFS-Mindverse/share/models/leijingdi/data/agent_memory_qasper_ctx8192_episode_safe_seed42.jsonl}"

# Runtime
ATTN_IMPLEMENTATION="${ATTN_IMPLEMENTATION:-flash_attention_2}"
WANDB_PROJECT="${WANDB_PROJECT:-delta-mem-qwen3}"

DELTA_WRITE_SPARSITY_WEIGHT="0.01"
DELTA_WRITE_SPARSITY_TARGET="0.05"

# Variant-specific delta hyperparameters
SSW_RUN_NAME="${SSW_RUN_NAME:-qwen3_4b_instruct_delta_mem_qasper_6k_seed42_rank8_qo_SSW_write8192_consistent70}"
SSW_OUTPUT_DIR="${SSW_OUTPUT_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_4b_instruct_delta_mem_qasper_6k_seed42_rank8_qo_SSW_write8192_consistent70}"
SSW_NUM_STATE_HEADS="${SSW_NUM_STATE_HEADS:-1}"
SSW_WRITE_GRANULARITY="${SSW_WRITE_GRANULARITY:-message_mean}"
SSW_MASTER_PORT="${SSW_MASTER_PORT:-29682}"
SSW_WANDB_GROUP="${SSW_WANDB_GROUP:-qasper-multimodel-write8192-delta}"
SSW_WANDB_TAGS="${SSW_WANDB_TAGS:-qasper,delta,SSW,write8192,consistent70}"

TSW_RUN_NAME="${TSW_RUN_NAME:-qwen3_4b_instruct_delta_mem_qasper_6k_seed42_rank8_qo_TSW_write8192_consistent70}"
TSW_OUTPUT_DIR="${TSW_OUTPUT_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_4b_instruct_delta_mem_qasper_6k_seed42_rank8_qo_TSW_write8192_consistent70}"
TSW_NUM_STATE_HEADS="${TSW_NUM_STATE_HEADS:-1}"
TSW_WRITE_GRANULARITY="${TSW_WRITE_GRANULARITY:-token}"
TSW_MASTER_PORT="${TSW_MASTER_PORT:-29683}"
TSW_WANDB_GROUP="${TSW_WANDB_GROUP:-qasper-multimodel-write8192-delta}"
TSW_WANDB_TAGS="${TSW_WANDB_TAGS:-qasper,delta,TSW,write8192,consistent70}"

MSW_RUN_NAME="${MSW_RUN_NAME:-qwen3_4b_instruct_delta_mem_qasper_6k_seed42_MSW_write8192_consistent70}"
MSW_OUTPUT_DIR="${MSW_OUTPUT_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_4b_instruct_delta_mem_qasper_6k_seed42_MSW_write8192_consistent70}"
MSW_NUM_STATE_HEADS="${MSW_NUM_STATE_HEADS:-4}"
MSW_WRITE_GRANULARITY="${MSW_WRITE_GRANULARITY:-token}"
MSW_MASTER_PORT="${MSW_MASTER_PORT:-29684}"
MSW_WANDB_GROUP="${MSW_WANDB_GROUP:-qasper-multimodel-write8192-delta}"
MSW_WANDB_TAGS="${MSW_WANDB_TAGS:-qasper,delta,MSW,write8192,consistent70}"
