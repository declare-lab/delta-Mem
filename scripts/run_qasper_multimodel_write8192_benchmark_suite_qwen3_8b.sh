...
SUITE_ROOT="/vePFS-Mindverse/share/models/leijingdi/results/qasper_multimodel_write8192_benchmark_suite_qwen3_8b_consistent70"
...
SSW_ADAPTER_DIR="${SSW_ADAPTER_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_8b_delta_mem_qasper_6k_seed42_rank8_qo_SSW_write8192_consistent70/trainer/checkpoint-70}"
TSW_ADAPTER_DIR="${TSW_ADAPTER_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_8b_delta_mem_qasper_6k_seed42_rank8_qo_TSW_write8192_consistent70/trainer/checkpoint-70}"
MSW_ADAPTER_DIR="${MSW_ADAPTER_DIR:-/vePFS-Mindverse/share/models/leijingdi/models/qwen3_8b_delta_mem_qasper_6k_seed42_MSW_write8192_consistent70/trainer/checkpoint-70}"
